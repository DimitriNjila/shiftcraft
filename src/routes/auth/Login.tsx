  ...
  return (
    <div className="editorial-panel">
      ...
      <div className="relative flex items-center gap-2.5">
        <span className="label-md" style={{ fontSize: 10 }}>Vol. 26 · Week 17</span>
        <div className="w-5 h-px bg-outline-variant opacity-40" />
        <span className="label-md" style={{ fontSize: 10 }}>Precision Hospitality</span>
      </div>
      ...
      <div className="relative mt-5 flex items-center gap-3.5">
        <div
          ...
          style={{ background: 'oklch(0.82 0.06 30)', color: 'oklch(0.28 0.08 30)' }}
        >
          EK
        </div>
        <div className="flex-1">
          <p className="body-sm italic text-on-surface leading-[1.4]">
            "Our Friday-night schedule used to be a four-hour spreadsheet. Now it's fifteen minutes."
          </p>
          <p className="label-sm mt-1" style={{ fontSize: 10 }}>Elena Kovač · GM, Meridian Coffee</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="flex-1 flex items-center justify-start">
          <div className="w-full max-w-[400px]">
            ...
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="label-sm" style={{ fontSize: 10 }}>or with email</span>
              <div className="flex-1 h-px bg-outline-variant opacity-30" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
              ...
              <div>
                <div className="flex justify-between mb-1.5">
                  ...
                  <button
                    type="button"
                    className="label-md text-primary bg-transparent border-none cursor-pointer"
                    style={{ fontSize: 11 }}
                  >
                    Forgot?
                  </button>
            ...
            <p className="body-sm text-center mt-5 text-on-surface-muted">
              New to Shiftcraft?{' '}
              <Link to="/signup" className="text-primary font-semibold no-underline">
                Start a free trial
              </Link>
            </p>
          </div>
